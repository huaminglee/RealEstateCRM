...
{//this is notebook v1.0
    ...
    public class Context : DbContext
    {
        ...
        //public DbSet<ClientInvalid> ClientInvalid { }
                ...
                List<Function> funlist = new List<Function>
                                             {
                                                 ...
                                                 new Function {Name = "前台", ParentName = "客户管理", Sort = 0},
                                                  new Function {Name = "销售员", ParentName = "客户管理", Sort = 0},
                                                   new Function {Name = "电话中心", ParentName = "客户管理", Sort = 0},
                                                 new Function {Name = "客户查询", ParentName = "客户管理", Sort = 0},
                                                 new Function {Name = "客户编辑", ParentName = "客户管理", Sort = 0},
                                                 new Function {Name = "客户到访记录", ParentName = "客户管理", Sort = 0},
...
context.SaveChanges();
                ...
                List<Department> departments = new List<Department>
                                                   {
                                                       ...
                                                       new Department {Name = "电话中心", PId = 1, DepartmentType = "部门"},
                                                       new Department {Name = "徐汇滨江", PId = 1, DepartmentType = "项目"},
                                                       new Department {Name = "北外滩", PId = 1, DepartmentType = "项目"},
                                                       new Department {Name = "芳满庭", PId = 1, DepartmentType = "项目"},
                                                       new Department {Name = "派克公馆", PId = 1, DepartmentType = "项目"},
                                                       new Department {Name = "前台", PId = 4, DepartmentType = "小组"},
                                                       new Department {Name = "A组", PId = 4, DepartmentType = "小组"},
                                                       new Department {Name = "B组", PId = 4, DepartmentType = "小组"},
                                                       new Department {Name = "C组", PId = 4, DepartmentType = "小组"},
                                                       new Department {Name = "公共客户", PId = 4, DepartmentType = "小组"},
                                                       new Department {Name = "沉睡客户", PId = 4, DepartmentType = "小组"}
                                                   };
                ...
                List<SystemUser> users = new List<SystemUser>
                                             {
                                                 ...
                                                 new SystemUser {LoginName="TelA",Name="电话中心A",Password="11"}
                                             };
                users.ForEach(o =>
                              {
                ...
                context.RoleUsers.Add(new RoleUser { RoleId = 7, UserId = 2 });
                ...
                List<OUDAL.DictionaryItem> dictionaryItems = new List<DictionaryItem>
                                                               {
                                                                   new DictionaryItem{DictId = 1,IndexNum = 1,Name = "住宅"},
                                                                   new DictionaryItem{DictId = 1,IndexNum = 2,Name = "类住宅"},
                                                                   new DictionaryItem{DictId = 1,IndexNum = 3,Name = "办公"},
