...
namespace RealEstateCRM.Web.BLL
{
    public class ClientBLL
    {
        ...
        public static void AutoTransfer(int project, ClientStateEnum state, int gonggong, int chenshui)
        {
            ...
            string sql = @"select c.* from clients c join departments d on c.groupid=d.id join roomtypes t on t.departmentid=c.projectid and t.name=c.roomtype where c.createtime>'2013-12-1' and c.projectid={0} and  c.state={1} and t.{2} >0 and  DATEADD(dd,t.{2},c.statedate)<getdate()";
